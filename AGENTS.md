...
- Doğrulama: `npm test` içinde production build ve **18 test geçti; 0 başarısız, 0 atlandı**. `npm run lint` **0 hata**, optimize edilecek ham görseller için **17 uyarı** ile tamamlandı. Tarayıcıda ana sayfa 1440, 768 ve 390 px genişliklerde yatay taşma olmadan doğrulandı; kırık görsel bulunmadı. Admin dashboard ve 15 alanlı haber editörü açıldı, konsolda hata görülmedi.
