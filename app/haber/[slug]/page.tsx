...
export default async function ArticlePage({ params }: Props) {
  ...
  const breadcrumbLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Koza TV", item: fullUrl("/") }, { "@type": "ListItem", position: 2, name: article.category, item: fullUrl(categoryHref) }, { "@type": "ListItem", position: 3, name: article.title, item: shareUrl }] };
