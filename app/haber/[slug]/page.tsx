...
export default async function ArticlePage({ params }: Props) {
  ...
  return <main className="article-page">
    ...
    <article className="article-container">
      ...
      <figure className="article-figure"><div>{article.isBreaking ? <b className="breaking-ribbon">SON DAKİKA</b> : null}<img src={article.heroImage} alt={article.imageAlt} /></div><figcaption>{article.imageAlt} · Fotoğraf: {article.sourceName}</figcaption></figure>
