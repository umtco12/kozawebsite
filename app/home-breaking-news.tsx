...
/* Ana sayfadaki "ANLIK · Haber Akışı" kutusu.
...
export function HomeBreakingNews({ initialItems }: { initialItems: BreakingItem[] }) {
  ...
  return (
    <aside className="home-breaking-news" aria-labelledby="home-breaking-heading" ref={region} onBlur={(event) => {
      ...
      <header><span className="home-breaking-kicker"><i aria-hidden="true" /> ANLIK</span><h2 id="home-breaking-heading">Haber Akışı</h2></header>
      <ol>
        {items.map((article) => {
